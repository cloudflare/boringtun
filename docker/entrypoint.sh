...
log_startup_fingerprint() {
	...
	echo "[startup-fingerprint] raw_wg_server_address=${RAW_WG_SERVER_ADDRESS:-$WG_SERVER_ADDRESS} normalized_wg_server_address=$WG_SERVER_ADDRESS wg_config_path=$WG_CONFIG_PATH"
}
